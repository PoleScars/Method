...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption[(a) 3D schematic of copper plate mould with dimentions. (b) Cast \MgZnCa~ master alloy plate within mould.]{(a) 3D schematic of copper plate mould with dimentions. (b) Cast \MgZnCa~ master alloy plate within mould. (a) reproduced from \cite{Laws2007}.}%global caption
...
The films were deposited by an in house \acrshort{dc} magnetron sputtering facility (Figure \ref{fig:CaoSputtering}). This facility has a maximum power of 50 W, with a working gas of ultra-high purity Ar (99.999\%). The sputtering gun nominal target diameter is $25.4 mm$ ($1 in$). The working distance between target and substrate holder is $8 cm$. The chamber can achieve a base vacuum pressure of at least $10^{-2} Pa$, and a working Ar pressure of at least $2 Pa$ at constant flow rate of $2 cm^{3}/s$. The chamber has direct access and a large deposition area, allowing for batch processing of multiple substrates simultaneously.
