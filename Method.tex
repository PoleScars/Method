...
The production of all bulk and film samples required master alloy of the desired stoichiometry of \MgZnCa. These master alloys were produced by induction melting of pure constituent element ingots.
...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption[(a) In-house ad hoc inducting casting chamber. (b) Boron nitrate coated graphite crucible with Mg and Zn ingot charge.]{(a) In-house ad hoc inducting casting chamber. (b) Boron nitrate coated graphite crucible with Mg and Zn ingot charge. (a) reproduced from \cite{Laws2007}.}%global caption
	\label{fig:Induction}
\end{figure}
...
Injection cast bulk samples were prepared as per the method detailed in Section \ref{sec:MasterInjectionCasting}. Two different moulds were used, one for rods and one for plates. The rod mould produced samples of nominal $2.5 mm$ diameter. The plate mould produced two plates of nominal $1.2 mm$ thickness stemming off a central rod spine of $4 mm$ diameter.  
...
\subsection{Gravity Casting}
Gravity cast semi-crystalline targets were prepared as per the method detailed in Section \ref{sec:MasterGravityCasting}. For casting these semi-crystalline targets a flat plate mould was used. The casting cavity of this mould was $100 x 50 mm$ with spacers allowing for thicknesses ranging from $2 mm$ to several $mm$, with $4 mm$ plate proving the most practical (Figure \ref{fig:PlateMould}). The $4 mm$ plate variation has a volume of approximately $20 cc$ with the riser holding an additional $15.5 cc$. The mould was prepared by cleaning with lint free paper, polishing with Brasso \textcopyright, and wiping clean again with the paper.
...
Once master alloy plate was cast the riser was removed. The plate was mounted in a polymer grip vice and the riser carefully cut off with a 24 or 32 \acrshort{tpi} hacksaw. Paper was placed under the vice grips to capture the metallic saw dust for later analysis (Figure \ref{fig:Vice}).
...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption{(a) Polymer grip vice clamping plate below riser with 32 \acrshort{tpi} hacksaw. (b) Fully shaped, unpolished target with 2 Euro coin and washer template. (c) Notched $32 mm$ diameter diamond holesaw. (d) Drill press, holesaw, horizontial vice with polymer grips, plywood damper, and drip tray for target extraction.}%global caption
...
Films were deposited directly onto Al \gls{dsc} lids to use as the main substrate for these works. These substrates were used as they allowed for the collection of reliable \gls{dsc} data, and could be used to obtain coincident results with other techniques. 

\subsection{Silica Glass Substrate}
Silicon glass substrates were primarily used for film thickness measurements. They could also be used to verify that results were consistent across various substrates by comparing with the \gls{dsc} lid results. These substrates were cleaned in an ethanol ultrasound bath for at least 1 minute before being used. 

\subsection{Silicon Wafer Substrate}
Depositions onto un-doped, \gls{ssp} $500 \pm 10 \mu m$,  (100) silicon wafer was occasionally used for specific \gls{xrd} and other experiments. These substrate were used for these specialised experiments as some film properties can to be more easily examined with the minimal substrate influence available from Si compared to other substrates. These substrates were cleaned in an ethanol ultrasound bath for at least 1 minute before being used. 
...
\begin{table}[h]
	\centering
	\caption{Example isothermal crystallisation \acrshort{dsc} variable heating rate profile to 100\degree C. An isothermal experiment at a higher temperature would add the difference to each step, except for the starting temperature (i.e. for 105\degree C, add 5\degree C to all steps except for 25\degree C).}
	\begin{tabular}{cccc}
		\toprule
...
Annealing \acrshort{xrd} (Empyrean, PANalytical, The Netherlands, Cu $K_{\alpha}$ X-ray source, $\lambda = 1.541 \angstrom$) was performed on heat treated bulk rods, and films at room temperature. 
With a generator voltage $45 kV$, tube current $40 mA$, scan step size 0.0262606, and time per step of 397.29. 

Dynamic \acrshort{xrd} (D8, Bruker, Germany, Cu $K_{\alpha}$ X-ray source, $\lambda = 1.541 \angstrom$) was performed on as manufactured bulk injection plates, and films by raising temperature at a rate of $20 K/min$ and performing scans \textit{in situ}. The first scan was performed at $35$\degree C, then $75$\degree C, after which temperature was raised in $5$\degree C increments until reaching a final temperature at $185$\degree C. The $2 \theta$ scans from $31 - 60$\degree~ were completed within $1092 sec$ ($18min,~ 12sec$) to minimise the effects of recrystallisation at temperature during the experiment.
